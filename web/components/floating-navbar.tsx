    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-2 cursor-pointer group">
          <div className="w-10 h-10 bg-brand-orange text-white rounded-xl flex items-center justify-center shadow-lg group-hover:-translate-y-1 transition-transform">
        ...
        <div className="flex items-center">
          <button className="bg-brand-slate text-white px-6 py-2.5 rounded-full font-bold hover:bg-brand-orange transition-colors shadow-md hover:shadow-xl hover:-translate-y-0.5 duration-200">
            Get Demo
          </button>
        </div>
      </div>
