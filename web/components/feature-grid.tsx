...
const features = [
  {
    icon: <Activity size={24} className="text-brand-teal" />,
  ...
  {
    icon: <Layers size={24} className="text-brand-teal" />,
  ...
  {
    icon: <Shuffle size={24} className="text-brand-teal" />,
    ...
    <section id="features" className="py-24 relative z-10 w-full max-w-7xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {features.map((feat, idx) => (
          ...
          >
            <div className="w-14 h-14 bg-teal-50 rounded-2xl flex items-center justify-center mb-6 shadow-inner">
              {feat.icon}
            </div>
            ...
            <div className="text-brand-teal font-bold flex items-center gap-2 group-hover:gap-3 transition-all cursor-pointer">
